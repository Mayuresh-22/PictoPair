...
public class GameLayout implements ScreenStructure {
    ...
    public void createScorePanel() {
        ...
        JLabel matches = new GradientLabel("Matches : 0",new Color(71, 88, 250),new Color(71, 88, 250));
        JLabel turns = new GradientLabel("Turns : 0",new Color(71, 88, 250),new Color(71, 88, 250));
