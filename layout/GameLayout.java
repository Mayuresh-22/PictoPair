...
public class GameLayout implements ScreenStructure {
    ...
    public void createCardsPanel(){
        cardsPanel.setBounds((int)(ScreenStructure.WIDTH*0.05),(int)(ScreenStructure.HEIGHT*0.05), (int)(ScreenStructure.WIDTH*0.7), (int)(ScreenStructure.HEIGHT*0.9));
        cardsPanel.setOpaque(true);
        cardsPanel.setBorder(new TextBubbleBorder(new Color(200, 200, 200), 5, 70, 0));
    }
}